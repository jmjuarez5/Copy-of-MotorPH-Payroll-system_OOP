...
public enum ValidationRule {
    ...
    DUPLICATE_EMPLOYEE_ID("Employee ID already exists.", s -> {
        if (s == null || s.trim().isEmpty()) return true;
        // This will be checked against the database in the service layer
        return true; // Always return true here, validation happens in service
    });
