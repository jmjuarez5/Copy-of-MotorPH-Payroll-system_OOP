...
public class AdminPortal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ViewEmpDetailsPortal.setBackground(new java.awt.Color(176, 196, 222));
        ...
        UpdateEmpDetailsPortal.setBackground(new java.awt.Color(176, 196, 222));
        ...
        AdminPortalTXT.setText("Admin Portal");
    ...
    private void UpdateEmpDetailsPortalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateEmpDetailsPortalActionPerformed
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(filePath))) {
            ...
            // Read each line from the CSV file and load it into the portal's table
            while ((line = br.readLine()) != null) {
                ...
                // Validate data array before adding to model
                if (data != null && data.length > 0) {
                    // Direct access to updateTable since it's now public
                    if (portal.updateTable != null) {
                        javax.swing.table.DefaultTableModel model = (javax.swing.table.DefaultTableModel) portal.updateTable.getModel();
                        if (model != null) {
                            model.addRow(data);
                        }
                    }
            ...
            javax.swing.JOptionPane.showMessageDialog(this, 
                "Employee data file not found: " + filePath, 
                "File Error", 
                javax.swing.JOptionPane.ERROR_MESSAGE);
        } catch (java.io.IOException e) {
            javax.swing.JOptionPane.showMessageDialog(this, 
                "Error reading employee data file: " + e.getMessage(), 
                "Read Error", 
                javax.swing.JOptionPane.ERROR_MESSAGE);
        } catch (Exception e) {
            javax.swing.JOptionPane.showMessageDialog(this, 
    ...
    /**
     * Clear session data to ensure proper logout.
     */
    private void clearSessionData() {
        // Clear any cached user data or session variables
        // In a real application, this would clear session storage
        // For now, we ensure the frame is properly disposed
